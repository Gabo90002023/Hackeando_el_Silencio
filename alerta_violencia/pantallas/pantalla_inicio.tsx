...
import { Alerta, RootStackParamList } from '../navigation/AppNavigator';
...
const alertasEjemplo: Alerta[] = [
  {
    ...
    motivo: 'Amenaza directa detectada en el contenido del mensaje.',
    palabrasClave: ['te voy a buscar', 'contestas ahora'],
    recomendacion: 'Contactar a una persona de confianza y guardar evidencia del mensaje.',
  },
  {
    id: 2,
    remitente: 'Messenger',
    ...
    motivo: 'Lenguaje ofensivo y descalificación personal.',
    palabrasClave: ['no sirves para nada'],
    recomendacion: 'Revisar el contexto del mensaje y considerar apoyo emocional o bloqueo.',
  },
  {
    id: 3,
    remitente: 'SMS',
    ...
    motivo: 'Presión comunicacional insistente.',
    palabrasClave: ['necesito hablar contigo ya'],
    recomendacion: 'Monitorear si este patrón se repite en mensajes futuros.',
  },
];

type NavegacionTipo = NativeStackNavigationProp<RootStackParamList, 'Inicio'>;
...
export default function Pantalla_inicio() {
  const navigation = useNavigation<NavegacionTipo>();
      ...
      <ScrollView contentContainerStyle={estilos.contenedor}>
        ...
        {alertasEjemplo.map((alerta) => (
          ...
          >
            ...
            <Text style={estilos.verDetalle}>Tocar para ver detalle</Text>
          </TouchableOpacity>
        ))}
      </ScrollView>
    </SafeAreaView>
